...
class TranslationsControllerTest < ActionController::TestCase
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post :create, translation: { core_language: @translation.core_language, target_language: @translation.target_language }
    end
  ...
  test "should update translation" do
    patch :update, id: @translation, translation: { core_language: @translation.core_language, target_language: @translation.target_language }
    assert_redirected_to translation_path(assigns(:translation))
  end
